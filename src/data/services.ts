...
export const servicesData: Record<string, ServiceData> = {
  ...
  'odoo-development': {
    ...
    benefits: ['Perfectly tailored to your business workflows', 'Seamless integration with existing Odoo modules', 'Clean, maintainable, upgrade-safe code', 'Comprehensive testing and documentation', 'Ongoing maintenance and version upgrades', 'Published 140 modules — proven track record'],
